...
public class PlayGame {
    ...
    public static void main(String[] args) {
        ...
        gamer1.setTeam(TeamEnum.BLUE);
        Gamer gamer2 = new Gamer("gamer2");
        gamer2.setTeam(TeamEnum.RED);


        // 커맨드타워 생성
        CommandTower commandTower1 = new CommandTower(TeamEnum.BLUE);
        CommandTower commandTower2 = new CommandTower(TeamEnum.RED);
