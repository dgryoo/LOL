...
public abstract class HeroLegacy extends AttackableThing implements Movable, Revivable {

    private int level;
    private int experience;


    public HeroLegacy(String tName, int health, Team team, int armor, int magicArmor, int x, int y, int power, int attackRange) {
